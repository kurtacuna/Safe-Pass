...
class VisitorRegistration(APIView):
    ...
    def post(self, request):
        ...
        try:
            # Check the image and capture the response
...
class UpdateVisitorDetailsView(APIView):
    ...
    def post(self, request):
        ...
        except models.VisitorDetails.DoesNotExist:  # Fixed: was using 'visitor.DoesNotExist'
...
class UpdateVisitorPhotoView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            print(f"UpdateVisitorPhotoView: {str(e)}")
            return Response({"detail": str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
