...
class ApiUrls {
  ...
  static String visitorCheckOutSearchUrl = '$_appBaseUrl/api/visitor_logs/check-out-search/';
  static String visitorCheckOutUrl = '$_appBaseUrl/api/visitor_logs/check-out/';
